...
export const metadata = {
    title: 'Voorwaarden — VindFysio',
    description: 'Lees de algemene voorwaarden van VindFysio.nl.',
};
                ...
                <div className="container" style={{ maxWidth: 720 }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 24, fontSize: '0.938rem', lineHeight: 1.7, color: 'var(--text-secondary)' }}>
                        <div>
                            ...
                            <p>VindFysio.nl is een informatieplatform dat bezoekers helpt bij het vinden van fysiotherapiepraktijken in Nederland. De informatie op deze website is uitsluitend bedoeld ter informatie.</p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p>Deze website bevat links naar websites van derden. VindFysio is niet verantwoordelijk voor de inhoud van deze externe websites.</p>
                        </div>
                        <div>
                            <h3 style={{ color: 'var(--text)', marginBottom: 8 }}>4. Wijzigingen</h3>
                            <p>VindFysio behoudt zich het recht voor om deze voorwaarden te allen tijde te wijzigen. We raden aan om deze pagina regelmatig te raadplegen.</p>
                        </div>
                    </div>
                </div>
            </div>
